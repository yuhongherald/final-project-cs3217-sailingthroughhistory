...
class PresetEvent: TurnSystemEvent, Activatable {
    ...
    override init(triggers: [Trigger], conditions: [Evaluate], actions: [Modify], displayName: String) {
        ...
        super.init(triggers: triggers, conditions: conditions, actions: actions, displayName: displayName)
    }
}
